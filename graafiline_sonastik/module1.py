...
def tõlkida():
    ...
    def tõlkida_check(event):
        ...
        if trin.lower()[0] in vene_letters:
            vast=Label(aken, text=f"{trin} on vene keeles:",bg="silver",fg="#AA4A44",font="Arial 20",height=1,width=55)
            vast.pack()
            try:
            ...
            k=Label(aken, text=f"{trin} on eesti keeles",bg="silver",fg="#AA4A44",font="Arial 20",height=1,width=55)
            k.pack()
            try:
               ...
               tron1=Label(aken, text=f"sona ei ole leitud",bg="silver",fg="#AA4A44",font="Arial 20",height=1,width=55)
               tron1.pack()
...
def lisa_sõna():
    ...
    u=Label(aken1, text="lisa vene sona:",bg="silver",fg="#AA4A44",font="Arial 20",height=1,width=55)
    uussona=Entry(aken1, text="lisa vene sona:",bg="silver",fg="#AA4A44",font="Arial 20",width=55)
    u.pack()
    uussona.pack()
    def sona_check(event):
        l= uussona.get()
        t=Label(aken1, text="tolgi seda sona:",bg="silver",fg="#AA4A44",font="Arial 20",height=1,width=55)
        ...
        def sona_check2(event):
            ...
            g=Label(aken1, text="sona on lisatud, proovi tolkida!",bg="silver",fg="#AA4A44",font="Arial 20",height=1,width=55)
            g.pack()
...
def muuda_sona():
    ...
    x=Label(aken2, text="vana sõna vene keeles: ",bg="silver",fg="#AA4A44",font="Arial 20",height=1,width=55)
    ...
    def continus(event):
        ...
        if klamb in vene_list:
            y=Label(aken2, text="uus sõna vene keeles: ",bg="silver",fg="#AA4A44",font="Arial 20",height=1,width=55)
            ...
            def continus2(event):
                ...
                k=Label(aken2, text=f"tolgi {klimb}: ",bg="silver",fg="#AA4A44",font="Arial 20",height=1,width=55)
                ...
                def continus3(event):
                    ...
                    for sona in eesti_list:
                        f.write(sona+"\n")
                    m=Label(aken2, text="sona on muudatud",bg="silver",fg="#AA4A44",font="Arial 20",height=1,width=55)
                    m.pack()
